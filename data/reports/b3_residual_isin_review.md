...
| core_exclusion_candidate_requires_scope_review | 8 |
...
| Scope reason | Rows |
|---|---:|
| primary_listing_missing_isin | 10 |
...
| scope_review_before_identifier_fill | 8 |

## Apply Eligibility

| Eligibility | Rows |
|---|---:|
| blocked_until_core_or_extended_scope_decision | 8 |
...
| scope_decision_for_core_extended_or_exclude_before_identifier_fill | 8 |

## Review Strategies

| Strategy | Rows |
|---|---:|
| decide_b3_core_extended_or_exclude_before_identifier_work | 8 |
...
| Class | Rows |
|---|---:|
| fund_or_trust_identifier_gap | 6 |
| inactive_or_legacy_identifier_gap | 2 |
