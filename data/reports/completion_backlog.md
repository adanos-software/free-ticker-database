...
Generated at: `2026-08-13T08:04:45Z`

## Summary

- Missing primary ISIN rows: `1144`
- Missing stock sectors: `1901`
- Missing ETF categories: `402`
- Official symbol collisions tracked in exchange references: `9675`
...
| 4 | NASDAQ | missing_isin_primary | 157 | candidate_for_official_followup | Separate official CSD/security registry or exchange detail feed with ISIN. | yes |
...
| 8 | NYSE ARCA | missing_isin_primary | 96 | candidate_for_official_followup | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | yes |
...
| 10 | BATS | missing_etf_category | 94 | candidate_for_official_followup | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
...
| 12 | NASDAQ | missing_etf_category | 63 | candidate_for_official_followup | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
...
| 2 | NASDAQ | All | 157 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 6 | NYSE ARCA | All | 96 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 9 | NYSE | All | 52 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 4 | NASDAQ | Stock | 62 | official_full | Official industry classification or reviewed FinanceDatabase sector fallback. | yes |
...
| 2 | NASDAQ | ETF | 63 | official_full | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
| 3 | NYSE ARCA | ETF | 53 | official_full | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
| 4 | LSE | ETF | 50 | official_full | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
...
| 3 | NASDAQ | 125 | 62 | 63 | official_full |
| 4 | TSX | 119 | 96 | 23 | official_full |
| 5 | BATS | 94 | 0 | 94 | official_full |
| 6 | LSE | 88 | 38 | 50 | official_full |
| 7 | NYSE ARCA | 53 | 0 | 53 | official_full |
| 8 | BSE_IN | 49 | 49 | 0 | official_full |
