...
Generated at: `2026-08-10T08:17:16Z`

## Summary

- Missing primary ISIN rows: `1118`
- Missing stock sectors: `1895`
- Missing ETF categories: `382`
- Official symbol collisions tracked in exchange references: `9669`
...
| 4 | NASDAQ | missing_isin_primary | 153 | candidate_for_official_followup | Separate official CSD/security registry or exchange detail feed with ISIN. | yes |
...
| 9 | NYSE ARCA | missing_isin_primary | 87 | candidate_for_official_followup | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | yes |
| 10 | BATS | missing_etf_category | 84 | candidate_for_official_followup | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
...
| 2 | NASDAQ | All | 153 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 6 | NYSE ARCA | All | 87 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 9 | NYSE | All | 50 | official_full | Official US exchange directories where available; EODHD or strict Yahoo for reviewed ETF residuals. | yes |
...
| 4 | NASDAQ | Stock | 59 | official_full | Official industry classification or reviewed FinanceDatabase sector fallback. | yes |
...
| 10 | NYSE | Stock | 17 | official_full | Official industry classification or reviewed FinanceDatabase sector fallback. | yes |
...
| 4 | NYSE ARCA | ETF | 44 | official_full | Same-ISIN peer propagation plus a reviewed ETF-name category classifier; official fund category feeds where available. | yes |
...
| 3 | NASDAQ | 121 | 59 | 62 | official_full |
| 4 | TSX | 119 | 96 | 23 | official_full |
| 5 | LSE | 88 | 38 | 50 | official_full |
| 6 | BATS | 84 | 0 | 84 | official_full |
| 7 | BSE_IN | 49 | 49 | 0 | official_full |
| 8 | XSTU | 47 | 45 | 2 | missing |
| 9 | Euronext | 46 | 9 | 37 | official_full |
| 10 | NYSE ARCA | 44 | 0 | 44 | official_full |
