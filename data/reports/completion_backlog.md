...
Generated at: `2026-06-10T12:52:27Z`

## Summary

- Missing primary ISIN rows: `929`
- Missing stock sectors: `2606`
...
| 2 | OTC | missing_sector_stock | 819 | candidate_for_official_followup | Current SEC SIC residual dry-run has no accepted OTC sector candidates; prioritize OTC Markets issuer evidence, reviewed Alpha Vantage/FinanceDatabase signals, or keep source-gap status. | yes |
...
| Rank | Exchange | Asset type | Missing | Venue | Source | Review |
|---|---|---|---:|---|---|---|
| 1 | OTC | Stock | 819 | official_full | SEC SIC, Alpha Vantage OVERVIEW, and FinanceDatabase as reviewed stock-sector signals. | yes |
...
|---|---|---:|---:|---:|---|
| 1 | OTC | 845 | 819 | 26 | official_full |
