...
- Active official source rows: **168,303**
- Source-specific venue/symbol keys: **168,302**
- Coverage-credited keys: **94,287**
- Exact identity conflicts: **12,589**
- In-scope missing listings: **47,863**

| Classification | Keys |
|---|---:|
| `alternate_listing_line` | 3,503 |
| `ambiguous_same_venue_identifier` | 193 |
| `exact_identity_conflict` | 12,589 |
| `exact_match` | 94,287 |
| `missing_from_database` | 47,863 |
