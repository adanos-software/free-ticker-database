...
| --- | ---: |
| Dataset rows | 1584 |
| Active directory match rate | 78.6 |
| Active directory missing rows | 339 |
| Any official B3 source match rate | 79.67 |
| Absent from all B3 source-gap rows | 322 |
...
| seek_current_b3_or_issuer_listing_evidence | 322 |
...
| P3 | b3_masterfile_gap | absent_from_all_b3_sources_fund_or_receipt_source_gap | ETF | unit_or_fund_line | 43 | seek_current_b3_or_issuer_listing_evidence | new_current_b3_directory_or_official_issuer_exchange_evidence_for_exact_listing_key |
| P3 | b3_masterfile_gap | absent_from_all_b3_sources_fund_or_receipt_source_gap | Stock | other | 16 | seek_current_b3_or_issuer_listing_evidence | new_current_b3_directory_or_official_issuer_exchange_evidence_for_exact_listing_key |
| P3 | b3_masterfile_gap | absent_from_all_b3_sources_local_share_source_gap | Stock | local_share_line | 263 | seek_current_b3_or_issuer_listing_evidence | new_current_b3_directory_or_official_issuer_exchange_evidence_for_exact_listing_key |
