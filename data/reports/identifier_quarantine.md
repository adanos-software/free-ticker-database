...
Generated: `2026-08-24T09:28:44Z`
...
- Proposed clears: **751**
- Quarantined unresolved assertions: **2,970**
- Identifier assertions retained with decisive evidence: **1,327**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,327 |
| `proposed_clear_conflicting_identifier` | 751 |
| `quarantined_unresolved_identifier` | 2,970 |
