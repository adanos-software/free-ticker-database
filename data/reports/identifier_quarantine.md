...
Generated: `2026-08-19T16:49:17Z`
...
- Listing decisions: **5,048**
- Identifier assertions cleared in explicit apply mode: **0**
- Proposed clears: **750**
- Quarantined unresolved assertions: **2,972**
- Identifier assertions retained with decisive evidence: **1,326**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,326 |
| `proposed_clear_conflicting_identifier` | 750 |
| `quarantined_unresolved_identifier` | 2,972 |
