...
Generated: `2026-08-19T14:19:11Z`
...
- Conflict groups adjudicated: **1,549**
- Listing decisions: **5,046**
- Identifier assertions cleared in explicit apply mode: **0**
- Proposed clears: **747**
- Quarantined unresolved assertions: **2,980**
- Identifier assertions retained with decisive evidence: **1,319**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,319 |
| `proposed_clear_conflicting_identifier` | 747 |
| `quarantined_unresolved_identifier` | 2,980 |
