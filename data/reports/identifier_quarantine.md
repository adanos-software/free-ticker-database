...
Generated: `2026-08-19T15:26:28Z`
...
- Proposed clears: **748**
- Quarantined unresolved assertions: **2,976**
- Identifier assertions retained with decisive evidence: **1,322**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,322 |
| `proposed_clear_conflicting_identifier` | 748 |
| `quarantined_unresolved_identifier` | 2,976 |
