...
Generated: `2026-08-18T20:23:15Z`
...
- Conflict groups adjudicated: **1,548**
- Listing decisions: **5,045**
- Identifier assertions cleared in explicit apply mode: **0**
- Proposed clears: **749**
- Quarantined unresolved assertions: **2,968**
- Identifier assertions retained with decisive evidence: **1,328**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,328 |
| `proposed_clear_conflicting_identifier` | 749 |
| `quarantined_unresolved_identifier` | 2,968 |
