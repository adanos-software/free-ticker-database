...
Generated: `2026-08-24T15:45:29Z`
...
- Conflict groups adjudicated: **1,552**
- Listing decisions: **5,054**
- Identifier assertions cleared in explicit apply mode: **0**
- Proposed clears: **750**
- Quarantined unresolved assertions: **2,974**
- Identifier assertions retained with decisive evidence: **1,330**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,330 |
| `proposed_clear_conflicting_identifier` | 750 |
| `quarantined_unresolved_identifier` | 2,974 |
