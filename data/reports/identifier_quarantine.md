...
- Proposed clears: **748**
- Quarantined unresolved assertions: **2,982**
- Identifier assertions retained with decisive evidence: **1,316**

## Actions

| Action | Rows |
|---|---:|
| `kept_listing_keyed_identifier` | 1,316 |
| `proposed_clear_conflicting_identifier` | 748 |
| `quarantined_unresolved_identifier` | 2,982 |
