...
Generated at: `2026-08-04T09:24:45Z`

- Venues: `81`
- Venue status: `{"official_full": 48, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 26, "maintain": 1, "refresh_required": 40, "refresh_unavailable": 14}`
...
| Euronext | official_full | euronext_equities|euronext_etfs |  | 2007 | 48.28 | euronext_equities|euronext_etfs | refresh_unavailable | not_applicable |
...
| HKEX | official_full | hkex_securities_list |  | 3206 | 94.85 | hkex_securities_list | refresh_required | not_applicable |
...
| IDX | official_full | idx_company_profiles|idx_listed_companies |  | 963 | 78.5 | idx_company_profiles|idx_listed_companies | refresh_required | not_applicable |
...
| KOSDAQ | official_full | krx_listed_companies |  | 1818 | 87.84 | krx_listed_companies | refresh_required | not_applicable |
| KRX | official_full | krx_etf_finder|krx_listed_companies |  | 2097 | 85.07 | krx_etf_finder|krx_listed_companies | refresh_required | not_applicable |
...
| OSL | official_full | euronext_equities|euronext_etfs |  | 298 | 83.56 | euronext_equities|euronext_etfs | refresh_unavailable | not_applicable |
...
| TSE | official_full | jpx_listed_issues|jpx_tse_stock_detail |  | 4437 | 91.35 | jpx_listed_issues|jpx_tse_stock_detail | refresh_required | not_applicable |
