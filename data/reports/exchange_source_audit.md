...
Generated at: `2026-09-20T18:50:19Z`

- Venues: `88`
- Venue status: `{"missing": 5, "official_full": 50, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 24, "maintain": 14, "official_source_required": 5, "refresh_required": 29, "refresh_unavailable": 16}`
...
| AMS | official_full | euronext_equities|euronext_etfs |  | 609 | 61.25 | euronext_etfs | refresh_required | not_applicable |
...
| B3 | official_full | b3_bdr_etfs|b3_instruments_equities|b3_listed_etfs |  | 1353 | 90.17 | b3_bdr_etfs|b3_instruments_equities|b3_listed_etfs | refresh_unavailable | not_applicable |
...
| BME | official_full | bme_etf_list|bme_listed_companies|bme_security_prices_directory |  | 271 | 90.77 | bme_etf_list|bme_listed_companies | refresh_required | not_applicable |
...
| Borsa Italiana | official_full | euronext_equities|euronext_etfs |  | 2908 | 8.6 | euronext_etfs | refresh_required | not_applicable |
...
| Euronext | official_full | euronext_equities|euronext_etfs |  | 2016 | 66.32 | euronext_etfs | refresh_required | not_applicable |
...
| HKEX | official_full | hkex_securities_list |  | 3204 | 94.48 |  | maintain | not_applicable |
...
| ISE | official_full | euronext_equities |  | 16 | 56.25 |  | maintain | not_applicable |
...
| KOSDAQ | official_full | krx_listed_companies |  | 1814 | 87.54 |  | maintain | not_applicable |
| KRX | official_full | krx_etf_finder|krx_listed_companies |  | 2109 | 92.6 |  | maintain | not_applicable |
| LSE | official_full | lse_company_reports|lse_instrument_directory|lse_price_explorer |  | 11140 | 61.29 | lse_company_reports|lse_instrument_directory | refresh_unavailable | not_applicable |
...
| NEO | official_full | cboe_canada_listing_directory |  | 442 | 47.29 |  | maintain | not_applicable |
...
| PSE | official_full | pse_listed_company_directory |  | 381 | 40.16 |  | maintain | not_applicable |
| PSE_CZ | official_partial | pse_cz_shares_directory |  | 0 |  | pse_cz_shares_directory | denominator_missing | blocked_nonfresh_source |
| PSX | official_full | psx_dps_symbols|psx_listed_companies|psx_symbol_name_daily |  | 724 | 53.87 | psx_listed_companies|psx_symbol_name_daily | refresh_required | not_applicable |
