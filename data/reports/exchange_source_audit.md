...
Generated at: `2026-09-21T16:37:51Z`

- Venues: `88`
- Venue status: `{"missing": 5, "official_full": 50, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 25, "maintain": 25, "official_source_required": 5, "refresh_required": 18, "refresh_unavailable": 15}`

| Exchange | Status | Sources | Missing products | Denominator | Recall | Nonfresh | Outcome | Promotion |
|---|---|---|---|---:|---:|---|---|---|
| ADX | official_full | adx_market_watch |  | 122 | 68.85 |  | maintain | not_applicable |
| AMS | official_full | euronext_equities|euronext_etfs |  | 609 | 61.25 | euronext_etfs | refresh_required | not_applicable |
| ASX | official_partial | asx_investment_products|asx_listed_companies |  | 0 |  |  | denominator_missing | blocked_denominator_missing |
...
| BIST | official_full | bist_kap_mkk_listed_securities |  | 661 | 92.44 |  | maintain | not_applicable |
...
| BMV | official_partial | bmv_capital_trust_search|bmv_etf_search|bmv_issuer_directory|bmv_market_data_securities|bmv_stock_search |  | 0 |  | bmv_issuer_directory|bmv_stock_search | refresh_unavailable | blocked_source_unavailable |
...
| BSE_IN | official_full | bse_india_scrips |  | 5165 | 51.31 |  | maintain | not_applicable |
| BVB | official_full | bvb_fund_units_directory|bvb_shares_directory |  | 89 | 49.44 | bvb_fund_units_directory | refresh_required | not_applicable |
...
| FSX | official_full | deutsche_boerse_frankfurt_all_tradable_equities |  | 18154 | 43.88 |  | maintain | not_applicable |
...
| NASDAQ | official_full | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 5628 | 81.45 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| SET | official_full | set_dr_search|set_etf_search|set_listed_companies|set_stock_search |  | 942 | 81.95 | set_dr_search|set_etf_search|set_listed_companies | refresh_required | not_applicable |
| SGX | official_full | sgx_securities_prices |  | 746 | 81.37 |  | maintain | not_applicable |
...
| TWSE | official_full | twse_etf_list|twse_listed_companies |  | 1094 | 92.69 | twse_etf_list | refresh_required | not_applicable |
...
| XETRA | official_full | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities |  | 5119 | 79.86 | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies | refresh_required | not_applicable |
