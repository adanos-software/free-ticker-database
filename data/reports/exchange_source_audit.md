...
Generated at: `2026-09-10T11:49:27Z`

- Venues: `87`
- Venue status: `{"missing": 5, "official_full": 49, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 24, "maintain": 10, "official_source_required": 5, "refresh_required": 33, "refresh_unavailable": 15}`

| Exchange | Status | Sources | Missing products | Denominator | Recall | Nonfresh | Outcome | Promotion |
|---|---|---|---|---:|---:|---|---|---|
| ADX | official_full | adx_market_watch |  | 122 | 69.67 |  | maintain | not_applicable |
...
| BIST | official_full | bist_kap_mkk_listed_securities |  | 655 | 93.28 |  | maintain | not_applicable |
...
| BVB | official_full | bvb_fund_units_directory|bvb_shares_directory |  | 349 | 24.64 | bvb_fund_units_directory | refresh_required | not_applicable |
...
| XETRA | official_full | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities |  | 5113 | 80.07 | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies | refresh_required | not_applicable |
