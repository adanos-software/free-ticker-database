...
- Audit outcomes: `{"denominator_missing": 26, "maintain": 23, "refresh_required": 21, "refresh_unavailable": 11}`
...
| BATS | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 1574 | 78.4 |  | maintain | not_applicable |
...
| NASDAQ | official_full | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 5584 | 80.75 |  | maintain | not_applicable |
...
| NSE_IN | official_full | nse_india_securities_available |  | 2978 | 76.9 |  | maintain | not_applicable |
| NSE_KE | official_full | nse_ke_listed_companies |  | 68 | 16.18 |  | maintain | not_applicable |
| NYSE | official_full | nasdaq_other_listed|sec_company_tickers_exchange |  | 3900 | 50.64 |  | maintain | not_applicable |
| NYSE ARCA | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 2693 | 95.28 |  | maintain | not_applicable |
...
| OTC | official_full | otc_markets_security_profile|otc_markets_stock_screener|sec_company_tickers_exchange |  | 11925 | 64.51 | otc_markets_stock_screener | refresh_unavailable | not_applicable |
| PSE | official_full | pse_listed_company_directory |  | 385 | 22.86 |  | maintain | not_applicable |
| PSE_CZ | official_partial | pse_cz_shares_directory |  | 0 |  |  | denominator_missing | blocked_denominator_missing |
| PSX | official_full | psx_dps_symbols|psx_listed_companies|psx_symbol_name_daily |  | 720 | 51.53 |  | maintain | not_applicable |
...
| STO | official_partial | nasdaq_nordic_stockholm_etfs|nasdaq_nordic_stockholm_shares|nasdaq_nordic_stockholm_trackers|ngm_companies_page|ngm_market_data_equities|spotlight_companies_directory |  | 0 |  | nasdaq_nordic_stockholm_etfs|nasdaq_nordic_stockholm_shares|nasdaq_nordic_stockholm_trackers|ngm_market_data_equities|spotlight_companies_directory | refresh_unavailable | blocked_source_unavailable |
...
| TSXV | official_full | tmx_interlisted_companies|tmx_listed_issuers |  | 1518 | 65.22 | tmx_interlisted_companies|tmx_listed_issuers | refresh_required | not_applicable |
