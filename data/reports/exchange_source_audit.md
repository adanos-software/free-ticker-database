...
Generated at: `2026-09-26T11:46:54Z`

- Venues: `88`
- Venue status: `{"missing": 5, "official_full": 50, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 24, "maintain": 2, "official_source_required": 5, "refresh_required": 41, "refresh_unavailable": 16}`

| Exchange | Status | Sources | Missing products | Denominator | Recall | Nonfresh | Outcome | Promotion |
|---|---|---|---|---:|---:|---|---|---|
| ADX | official_full | adx_market_watch |  | 122 | 68.85 | adx_market_watch | refresh_required | not_applicable |
...
| BATS | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 1646 | 79.4 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| BIST | official_full | bist_kap_mkk_listed_securities |  | 661 | 92.44 | bist_kap_mkk_listed_securities | refresh_required | not_applicable |
...
| BSE_IN | official_full | bse_india_scrips |  | 5165 | 51.31 | bse_india_scrips | refresh_required | not_applicable |
...
| HKEX | official_full | hkex_securities_list |  | 3204 | 94.48 | hkex_securities_list | refresh_required | not_applicable |
...
| KOSDAQ | official_full | krx_listed_companies |  | 1814 | 87.54 | krx_listed_companies | refresh_required | not_applicable |
| KRX | official_full | krx_etf_finder|krx_listed_companies |  | 2109 | 92.6 | krx_etf_finder|krx_listed_companies | refresh_required | not_applicable |
| LSE | official_full | lse_company_reports|lse_instrument_directory|lse_price_explorer |  | 11140 | 61.29 | lse_company_reports|lse_instrument_directory|lse_price_explorer | refresh_unavailable | not_applicable |
...
| NASDAQ | official_full | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 5646 | 81.4 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
| NEO | official_full | cboe_canada_listing_directory |  | 442 | 47.29 | cboe_canada_listing_directory | refresh_required | not_applicable |
...
| NYSE | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 3891 | 50.96 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| PSE | official_full | pse_listed_company_directory |  | 381 | 40.16 | pse_listed_company_directory | refresh_required | not_applicable |
| PSE_CZ | official_partial | pse_cz_shares_directory |  | 0 |  | pse_cz_shares_directory | denominator_missing | blocked_nonfresh_source |
| PSX | official_full | psx_dps_symbols|psx_listed_companies|psx_symbol_name_daily |  | 724 | 53.87 | psx_dps_symbols|psx_listed_companies|psx_symbol_name_daily | refresh_required | not_applicable |
...
| SGX | official_full | sgx_securities_prices |  | 746 | 81.37 | sgx_securities_prices | refresh_required | not_applicable |
...
| XETRA | official_full | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities |  | 5119 | 79.86 | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities | refresh_required | not_applicable |
