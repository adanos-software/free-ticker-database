...
Generated at: `2026-09-20T18:40:12Z`

- Venues: `88`
- Venue status: `{"missing": 5, "official_full": 50, "official_partial": 33}`
- Audit outcomes: `{"denominator_missing": 24, "maintain": 2, "official_source_required": 5, "refresh_required": 42, "refresh_unavailable": 15}`
...
| AMS | official_full | euronext_equities|euronext_etfs |  | 609 | 61.25 | euronext_equities|euronext_etfs | refresh_required | not_applicable |
...
| B3 | official_full | b3_bdr_etfs|b3_instruments_equities|b3_listed_etfs |  | 1353 | 90.17 | b3_bdr_etfs|b3_instruments_equities|b3_listed_etfs | refresh_required | not_applicable |
| BATS | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 1637 | 79.29 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| BIST | official_full | bist_kap_mkk_listed_securities |  | 660 | 92.58 | bist_kap_mkk_listed_securities | refresh_required | not_applicable |
...
| BSE_IN | official_full | bse_india_scrips |  | 4997 | 50.45 | bse_india_scrips | refresh_required | not_applicable |
...
| Borsa Italiana | official_full | euronext_equities|euronext_etfs |  | 2907 | 8.6 | euronext_equities|euronext_etfs | refresh_required | not_applicable |
...
| Euronext | official_full | euronext_equities|euronext_etfs |  | 2016 | 66.32 | euronext_equities|euronext_etfs | refresh_required | not_applicable |
| FSX | official_full | deutsche_boerse_frankfurt_all_tradable_equities |  | 18129 | 43.95 | deutsche_boerse_frankfurt_all_tradable_equities | refresh_required | not_applicable |
...
| HKEX | official_full | hkex_securities_list |  | 3207 | 94.73 | hkex_securities_list | refresh_required | not_applicable |
...
| KOSDAQ | official_full | krx_listed_companies |  | 1819 | 87.52 | krx_listed_companies | refresh_required | not_applicable |
...
| NASDAQ | official_full | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 5628 | 81.47 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
| NEO | official_full | cboe_canada_listing_directory |  | 443 | 47.4 | cboe_canada_listing_directory | refresh_required | not_applicable |
...
| NSE_IN | official_full | nse_india_securities_available |  | 3485 | 71.31 | nse_india_securities_available | refresh_required | not_applicable |
| NSE_KE | official_full | nse_ke_listed_companies |  | 68 | 16.18 | nse_ke_listed_companies | refresh_required | not_applicable |
| NYSE | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 3887 | 51.04 | nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| PSE | official_full | pse_listed_company_directory |  | 385 | 40.0 | pse_listed_company_directory | refresh_required | not_applicable |
...
| SGX | official_full | sgx_securities_prices |  | 747 | 81.39 | sgx_securities_prices | refresh_required | not_applicable |
...
| TXSE | official_full | nasdaq_other_listed |  | 4 | 0.0 |  | maintain | not_applicable |
...
| XETRA | official_full | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities |  | 5113 | 80.03 | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities | refresh_required | not_applicable |
