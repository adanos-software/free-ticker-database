...
- Audit outcomes: `{"denominator_missing": 22, "maintain": 5, "official_source_required": 5, "refresh_required": 40, "refresh_unavailable": 15}`
...
| B3 | official_full | b3_bdr_etfs|b3_instruments_equities|b3_listed_etfs |  | 1294 | 93.66 | b3_instruments_equities | refresh_required | not_applicable |
| BATS | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 1611 | 78.83 | nasdaq_other_listed|nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| BSE_IN | official_full | bse_india_scrips |  | 5117 | 52.02 | bse_india_scrips | refresh_required | not_applicable |
...
| FSX | official_full | deutsche_boerse_frankfurt_all_tradable_equities |  | 18047 | 44.33 | deutsche_boerse_frankfurt_all_tradable_equities | refresh_required | not_applicable |
...
| NASDAQ | official_full | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 5616 | 81.46 | nasdaq_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange | refresh_required | not_applicable |
...
| NYSE | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange |  | 3883 | 51.12 | nasdaq_other_listed|nasdaq_trading_system_adds_deletes|sec_company_tickers_exchange | refresh_required | not_applicable |
| NYSE ARCA | official_full | nasdaq_other_listed|nasdaq_trading_system_adds_deletes |  | 2708 | 95.53 | nasdaq_other_listed|nasdaq_trading_system_adds_deletes | refresh_required | not_applicable |
...
| SGX | official_full | sgx_securities_prices |  | 747 | 81.66 |  | maintain | not_applicable |
...
| SSE | official_partial | sse_a_share_list|sse_etf_list |  | 0 |  | sse_a_share_list|sse_etf_list | refresh_unavailable | blocked_source_unavailable |
...
| TADAWUL | official_full | tadawul_main_market_watch |  | 412 | 47.82 |  | maintain | not_applicable |
...
| XETRA | official_full | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities |  | 5097 | 80.42 | deutsche_boerse_etfs_etps|deutsche_boerse_listed_companies|deutsche_boerse_xetra_all_tradable_equities | refresh_required | not_applicable |
