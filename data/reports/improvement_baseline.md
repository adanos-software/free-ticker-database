...
| source_freshness_status_totals | `{"fresh": 8, "old": 128}` |
...
| Metric | Value |
|---|---:|
| baseline_context | `campaign_key=freshness;metric_count=14;nested_metric_count=8;numeric_row_total=4895` |
| source_count | `136` |
| source_freshness_status_totals | `{"fresh": 8, "old": 128}` |
| source_refresh_priority_totals | `{"P1": 33, "P2": 95, "P4": 8}` |
| source_refresh_queue_priority_totals | `{"fresh_no_refresh_needed": {"P4": 8}, "refresh_official_exchange_directory_before_identity_or_collision_work": {"P1": 33}, "refresh_official_subset_before_gap_enrichment": {"P2": 88}, "restore_or_replace_unavailable_source_before_data_fill": {"P2": 7}}` |
| source_refresh_action_totals | `{"no_refresh_needed": 8, "refresh_official_exchange_directory_before_identity_or_collision_work": 33, "refresh_official_subset_before_gap_enrichment": 88, "restore_or_replace_unavailable_source_before_data_fill": 7}` |
| old_official_exchange_directory_count | `33` |
| source_gap_rows | `3548` |
