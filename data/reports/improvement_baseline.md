...
Generated: `2026-06-02T04:35:33Z`
...
| source_freshness_status_totals | `{"fresh": 44, "old": 92}` |
...
| Metric | Value |
|---|---:|
| baseline_context | `campaign_key=freshness;metric_count=14;nested_metric_count=8;numeric_row_total=4883` |
| source_count | `136` |
| source_freshness_status_totals | `{"fresh": 44, "old": 92}` |
| source_refresh_priority_totals | `{"P1": 21, "P2": 71, "P4": 44}` |
| source_refresh_queue_priority_totals | `{"fresh_no_refresh_needed": {"P4": 44}, "refresh_official_exchange_directory_before_identity_or_collision_work": {"P1": 21}, "refresh_official_subset_before_gap_enrichment": {"P2": 64}, "restore_or_replace_unavailable_source_before_data_fill": {"P2": 7}}` |
| source_refresh_action_totals | `{"no_refresh_needed": 44, "refresh_official_exchange_directory_before_identity_or_collision_work": 21, "refresh_official_subset_before_gap_enrichment": 64, "restore_or_replace_unavailable_source_before_data_fill": 7}` |
