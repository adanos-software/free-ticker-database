...
| source_freshness_status_totals | `{"fresh": 27, "old": 109}` |
...
| source_count | `136` |
| source_freshness_status_totals | `{"fresh": 27, "old": 109}` |
| source_refresh_priority_totals | `{"P1": 25, "P2": 84, "P4": 27}` |
| source_refresh_queue_priority_totals | `{"fresh_no_refresh_needed": {"P4": 27}, "refresh_official_exchange_directory_before_identity_or_collision_work": {"P1": 25}, "refresh_official_subset_before_gap_enrichment": {"P2": 77}, "restore_or_replace_unavailable_source_before_data_fill": {"P2": 7}}` |
| source_refresh_action_totals | `{"no_refresh_needed": 27, "refresh_official_exchange_directory_before_identity_or_collision_work": 25, "refresh_official_subset_before_gap_enrichment": 77, "restore_or_replace_unavailable_source_before_data_fill": 7}` |
