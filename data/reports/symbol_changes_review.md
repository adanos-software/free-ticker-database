...
Generated at: `2026-07-05T09:21:20Z`
...
- Duplicate/cross-listing review rows: `17`
- Already reflected audit rows: `245`
- Out-of-scope collision blocked rows: `14`
...
| Status | Rows |
|---|---:|
| new_symbol_present_old_symbol_missing | 246 |
...
| Queue | Rows |
|---|---:|
| audit_already_reflected | 245 |
| blocked_missing_source_scope_mapping | 3 |
| blocked_out_of_scope_symbol_collision | 14 |
| document_no_dataset_match | 12 |
| review_duplicate_or_cross_listing | 17 |
...
| audit_already_reflected:recent_30d | 23 |
| audit_already_reflected:recent_7d | 4 |
...
| blocked_out_of_scope_symbol_collision:recent_7d | 2 |
...
| review_duplicate_or_cross_listing:recent_30d | 5 |
...
| Queue / Priority | Rows |
|---|---:|
| audit_already_reflected:P4 | 245 |
| blocked_missing_source_scope_mapping:P2 | 3 |
| blocked_out_of_scope_symbol_collision:P2 | 14 |
| document_no_dataset_match:P3 | 12 |
| review_duplicate_or_cross_listing:P1 | 17 |
...
|---|---:|
| audit_already_reflected:global_symbol_collision_outside_source_scope | 41 |
| audit_already_reflected:matches_within_source_scope | 204 |
| blocked_missing_source_scope_mapping:unscoped_source_hint | 3 |
| blocked_out_of_scope_symbol_collision:global_symbol_collision_outside_source_scope | 14 |
| document_no_dataset_match:matches_within_source_scope | 12 |
| review_duplicate_or_cross_listing:matches_within_source_scope | 17 |
...
|---|---:|
| audit_already_reflected:new_symbol_present_old_symbol_missing | 245 |
...
| review_duplicate_or_cross_listing:old_and_new_symbols_present | 17 |
...
|---|---|---:|
| audit_already_reflected | new_scoped_listing_key_only | 245 |
...
| review_duplicate_or_cross_listing | old_and_new_scoped_listing_keys_present | 17 |
...
|---|---|---:|
| audit_already_reflected | secondary_review | 245 |
| blocked_missing_source_scope_mapping | secondary_review | 3 |
| blocked_out_of_scope_symbol_collision | secondary_review | 14 |
| document_no_dataset_match | secondary_review | 12 |
| review_duplicate_or_cross_listing | secondary_review | 17 |
...
| Queue | Strategy | Rows |
|---|---|---:|
| audit_already_reflected | audit_already_reflected_no_canonical_change | 245 |
| blocked_missing_source_scope_mapping | map_source_exchange_scope_before_symbol_review | 3 |
| blocked_out_of_scope_symbol_collision | block_until_source_scope_and_non_symbol_identity_resolved | 14 |
| document_no_dataset_match | document_no_dataset_match_without_canonical_action | 12 |
| review_duplicate_or_cross_listing | resolve_duplicate_cross_listing_or_transition_before_any_symbol_change | 17 |
...
| audit_already_reflected | P4 | recent_7d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 3 |
...
| audit_already_reflected | P4 | recent_30d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 22 |
...
|---|---|---:|
| P1 | action_required_duplicate_or_cross_listing | 17 |
| P1 | action_required_possible_rename_or_delisting | 1 |
| P4 | already_reflected_in_scope_with_global_symbol_collision | 41 |
...
| Workflow queue | Rows |
|---|---:|
| review_duplicate_or_cross_listing | 8 |
| review_verified_rename_or_delisting | 1 |
...
| Eligibility | Rows |
|---|---:|
| audit_only_no_apply | 245 |
| blocked_until_exchange_scope_resolved | 17 |
...
| Readiness | Rows |
|---|---:|
| audit_only_no_canonical_change | 245 |
| blocked_until_listing_keyed_official_symbol_change_evidence | 18 |
| blocked_until_source_exchange_scope_and_non_symbol_identity_evidence | 17 |
...
| Evidence Gate | Rows |
|---|---:|
| audit_only_confirm_no_canonical_change_needed | 245 |
| official_exchange_directory_plus_listing_key_review_to_distinguish_duplicate_cross_listing_or_transition | 17 |
| official_exchange_notice_or_current_directory_showing_old_symbol_inactive_new_symbol_active_same_issuer | 1 |
| official_exchange_scope_and_non_symbol_identity_evidence_before_apply | 14 |
...
| Action | Rows |
|---|---:|
| already_reflected_or_new_symbol_added_in_source_scope | 246 |
...
| Scope Status | Rows |
|---|---:|
| global_symbol_collision_outside_source_scope | 55 |
| matches_within_source_scope | 234 |
