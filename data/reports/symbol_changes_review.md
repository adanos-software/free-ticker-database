...
Generated at: `2026-05-25T11:07:48Z`
...
| Status | Rows |
|---|---:|
| new_symbol_present_old_symbol_missing | 173 |
| no_matching_listing | 18 |
| old_and_new_symbols_present | 18 |
| old_symbol_present_new_symbol_missing | 33 |
...
| blocked_missing_source_scope_mapping | 2 |
| blocked_out_of_scope_symbol_collision | 28 |
| document_no_dataset_match | 18 |
| review_duplicate_or_cross_listing | 18 |
| review_verified_rename_or_delisting | 25 |

## Workflow Queue By Recency

| Queue / Recency | Rows |
|---|---:|
| audit_already_reflected:older_than_90d | 163 |
| audit_already_reflected:recent_90d | 9 |
...
| blocked_missing_source_scope_mapping:unscoped_source_hint | 2 |
...
| review_verified_rename_or_delisting:matches_within_source_scope | 25 |
...
| review_verified_rename_or_delisting:old_symbol_present_new_symbol_missing | 25 |
...
| review_verified_rename_or_delisting | old_scoped_listing_key_only | 25 |
...
| blocked_missing_source_scope_mapping | missing | 2 |
...
| review_verified_rename_or_delisting | US_LISTED | 25 |
...
| blocked_missing_source_scope_mapping | secondary_review | 2 |
...
| review_verified_rename_or_delisting | secondary_review | 25 |
...
| blocked_missing_source_scope_mapping | map_source_exchange_scope_before_symbol_review | 2 |
...
| review_verified_rename_or_delisting | verify_rename_or_delisting_with_official_venue_or_issuer_evidence | 25 |
...
| audit_already_reflected | P4 | recent_90d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 7 |
...
| audit_already_reflected | P4 | older_than_90d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 132 |
...
| P1 | action_required_possible_rename_or_delisting | 25 |
...
| P2 | manual_scope_mapping_required | 2 |
...
| requires_official_venue_confirmation | 43 |
...
| official_exchange_notice_or_current_directory_showing_old_symbol_inactive_new_symbol_active_same_issuer | 25 |
...
| source_exchange_mapping_before_any_symbol_change_review | 2 |

## Recommended Actions

| Action | Rows |
|---|---:|
| already_reflected_or_new_symbol_added_in_source_scope | 173 |
...
| review_possible_rename_or_delisting_in_source_scope | 33 |
...
| matches_within_source_scope | 200 |
| unscoped_source_hint | 2 |
