...
Generated at: `2026-08-04T09:48:02Z`
...
- Duplicate/cross-listing review rows: `30`
- Already reflected audit rows: `246`
- Out-of-scope collision blocked rows: `21`
- Missing source-scope mapping rows: `5`
- No-dataset-match documentation rows: `15`
- Time-sensitive review rows: `22`
...
| old_and_new_symbols_present | 30 |
...
| blocked_out_of_scope_symbol_collision | 21 |
| document_no_dataset_match | 15 |
| review_duplicate_or_cross_listing | 30 |
...
| review_duplicate_or_cross_listing:recent_7d | 13 |
...
| blocked_out_of_scope_symbol_collision:P2 | 21 |
| document_no_dataset_match:P3 | 15 |
| review_duplicate_or_cross_listing:P1 | 30 |
...
|---|---:|
| audit_already_reflected:global_symbol_collision_outside_source_scope | 43 |
| audit_already_reflected:matches_within_source_scope | 203 |
| blocked_missing_source_scope_mapping:unscoped_source_hint | 5 |
| blocked_out_of_scope_symbol_collision:global_symbol_collision_outside_source_scope | 21 |
| document_no_dataset_match:matches_within_source_scope | 15 |
| review_duplicate_or_cross_listing:matches_within_source_scope | 30 |
...
| review_duplicate_or_cross_listing:old_and_new_symbols_present | 30 |
...
| review_duplicate_or_cross_listing | old_and_new_scoped_listing_keys_present | 30 |
...
| review_duplicate_or_cross_listing | US_LISTED | 30 |
...
| blocked_out_of_scope_symbol_collision | secondary_review | 21 |
| document_no_dataset_match | secondary_review | 15 |
| review_duplicate_or_cross_listing | secondary_review | 30 |
...
| blocked_out_of_scope_symbol_collision | block_until_source_scope_and_non_symbol_identity_resolved | 21 |
| document_no_dataset_match | document_no_dataset_match_without_canonical_action | 15 |
| review_duplicate_or_cross_listing | resolve_duplicate_cross_listing_or_transition_before_any_symbol_change | 30 |
...
| audit_already_reflected | P4 | older_than_90d | global_symbol_collision_outside_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only comparison against official scoped exchange evidence; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 39 |

## Review Buckets

| Priority | Bucket | Rows |
|---|---|---:|
| P1 | action_required_duplicate_or_cross_listing | 30 |
| P1 | action_required_possible_rename_or_delisting | 2 |
| P4 | already_reflected_in_scope_with_global_symbol_collision | 43 |
| P4 | already_reflected_in_source_scope | 203 |
...
| Workflow queue | Rows |
|---|---:|
| review_duplicate_or_cross_listing | 20 |
| review_verified_rename_or_delisting | 2 |
...
| requires_official_venue_confirmation | 32 |
...
| Readiness | Rows |
|---|---:|
| blocked_until_listing_keyed_official_symbol_change_evidence | 22 |
...
| official_exchange_directory_plus_listing_key_review_to_distinguish_duplicate_cross_listing_or_transition | 30 |
| official_exchange_notice_or_current_directory_showing_old_symbol_inactive_new_symbol_active_same_issuer | 2 |
| official_exchange_scope_and_non_symbol_identity_evidence_before_apply | 21 |
...
| review_duplicate_or_cross_listing_state_in_source_scope | 30 |
...
| Scope Status | Rows |
|---|---:|
| global_symbol_collision_outside_source_scope | 64 |
