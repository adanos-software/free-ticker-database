...
Generated at: `2026-06-10T10:22:05Z`
...
- Rows: `278`
- Rename/delisting review rows: `36`
...
| old_symbol_present_new_symbol_missing | 46 |
...
| review_verified_rename_or_delisting | 36 |

## Workflow Queue By Recency

| Queue / Recency | Rows |
|---|---:|
| audit_already_reflected:older_than_90d | 168 |
| audit_already_reflected:recent_30d | 1 |
| audit_already_reflected:recent_90d | 4 |
...
| document_no_dataset_match:older_than_90d | 17 |
...
| review_verified_rename_or_delisting:recent_30d | 16 |
| review_verified_rename_or_delisting:recent_7d | 3 |
| review_verified_rename_or_delisting:recent_90d | 16 |

## Workflow Queue By Priority

| Queue / Priority | Rows |
|---|---:|
| audit_already_reflected:P4 | 173 |
...
| review_verified_rename_or_delisting:P1 | 36 |
...
| audit_already_reflected:matches_within_source_scope | 140 |
...
| review_verified_rename_or_delisting:matches_within_source_scope | 36 |

## Workflow Queue By Match Status

| Queue / Match Status | Rows |
|---|---:|
| audit_already_reflected:new_symbol_present_old_symbol_missing | 173 |
...
| review_verified_rename_or_delisting:old_symbol_present_new_symbol_missing | 36 |

## Workflow Queue By Listing-Key Review

| Queue | Listing-Key Status | Rows |
|---|---|---:|
| audit_already_reflected | new_scoped_listing_key_only | 173 |
...
| review_verified_rename_or_delisting | old_scoped_listing_key_only | 36 |
...
| audit_already_reflected | US_LISTED | 160 |
...
| document_no_dataset_match | US_LISTED | 13 |
| review_duplicate_or_cross_listing | US_LISTED | 18 |
| review_verified_rename_or_delisting | US_LISTED | 36 |

## Workflow Queue By Source Confidence

| Queue | Source Confidence | Rows |
|---|---|---:|
| audit_already_reflected | secondary_review | 173 |
...
| review_verified_rename_or_delisting | secondary_review | 36 |

## Workflow Queue By Review Strategy

| Queue | Strategy | Rows |
|---|---|---:|
| audit_already_reflected | audit_already_reflected_no_canonical_change | 173 |
...
| review_verified_rename_or_delisting | verify_rename_or_delisting_with_official_venue_or_issuer_evidence | 36 |
...
| review_verified_rename_or_delisting | P1 | older_than_90d | matches_within_source_scope | verify_rename_or_delisting_with_official_venue_or_issuer_evidence | official_exchange_notice_or_current_directory_showing_old_symbol_inactive_new_symbol_active_same_issuer | Official exchange notice, issuer notice, or current exchange directory proving old/new symbols for the same issuer. | Do not rename until official listing-keyed evidence proves old inactive and new active for the same issuer. | 1 |
...
| audit_already_reflected | P4 | recent_30d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 1 |
| audit_already_reflected | P4 | recent_90d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 3 |
...
| audit_already_reflected | P4 | older_than_90d | matches_within_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only confirmation from scoped listing records; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 136 |
| audit_already_reflected | P4 | older_than_90d | global_symbol_collision_outside_source_scope | audit_already_reflected_no_canonical_change | audit_only_confirm_no_canonical_change_needed | Audit-only comparison against official scoped exchange evidence; no canonical change. | Audit only; no ticker, listing, or name change is authorized. | 32 |
...
| P1 | action_required_possible_rename_or_delisting | 36 |
...
| Workflow queue | Rows |
|---|---:|
| review_verified_rename_or_delisting | 19 |
...
| P2:recent_7d | 1 |
| P2:recent_90d | 9 |
| P3:older_than_90d | 17 |
| P3:recent_90d | 2 |
| P4:older_than_90d | 168 |
| P4:recent_30d | 1 |
| P4:recent_90d | 4 |
...
| requires_official_venue_confirmation | 54 |
...
| blocked_until_listing_keyed_official_symbol_change_evidence | 54 |
...
| Readiness | Rows |
|---|---:|
| blocked_until_listing_keyed_official_symbol_change_evidence | 19 |
...
| official_exchange_notice_or_current_directory_showing_old_symbol_inactive_new_symbol_active_same_issuer | 36 |
...
| review_possible_rename_or_delisting_in_source_scope | 46 |
...
| matches_within_source_scope | 213 |
