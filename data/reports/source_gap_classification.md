...
Generated at: `2026-09-14T16:33:09Z`
...
- Official reference-gap rows classified: `6528`
...
| Class | Rows |
|---|---:|
| official_reference_unmatched_source_gap | 5396 |
| official_reference_symbol_collision_gap | 1132 |
| official_industry_taxonomy_unavailable_gap | 845 |
| otc_sector_source_gap | 554 |
| fund_or_trust_identifier_gap | 317 |
| official_identifier_not_exposed_source_gap | 306 |
...
| official_reference_gap | official_reference_unmatched_source_gap | BSE_IN | 207 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
...
| official_reference_gap | official_reference_symbol_collision_gap | BMV | 158 | Official exchange directory plus listing-key review for the row's exchange/security. | Do not close the gap from a same-symbol match on another exchange; require exact exchange/symbol/name/identifier evidence. |
...
| official_reference_gap | official_reference_symbol_collision_gap | ASX | 90 | Official exchange directory plus listing-key review for the row's exchange/security. | Do not close the gap from a same-symbol match on another exchange; require exact exchange/symbol/name/identifier evidence. |
...
| official_reference_gap | official_reference_unmatched_source_gap | BMV | 84 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
