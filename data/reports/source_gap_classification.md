...
Generated at: `2026-06-10T12:52:31Z`
...
- Missing stock-sector rows classified: `2606`
...
|---|---|---|---:|---|---|
| missing_sector_stock | otc_sector_source_gap | OTC | 819 | SEC SIC, issuer filings, OTCMarkets profile, or reviewed secondary company profile. | Canonical stock sector only after exchange/name gate; no ticker/name-only inference. |
