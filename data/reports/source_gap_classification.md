...
- Missing primary ISIN rows classified: `1271`
- Missing stock-sector rows classified: `67`
...
|---|---|---|---:|---|---|
| missing_isin_primary | official_identifier_not_exposed_source_gap | NASDAQ | 200 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
| missing_isin_primary | fund_or_trust_identifier_gap | NYSE | 154 | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | Exact fund/trust symbol and product name with checksum. |
| missing_isin_primary | official_identifier_not_exposed_source_gap | NYSE | 130 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
...
| missing_sector_stock | otc_sector_source_gap | OTC | 42 | SEC SIC, issuer filings, OTCMarkets profile, or reviewed secondary company profile. | Canonical stock sector only after exchange/name gate; no ticker/name-only inference. |
...
| missing_isin_primary | official_identifier_reference_unmatched_gap | NASDAQ | 31 | Official exchange directory, alias review, or CSD/security registry detail. | Require an exact official symbol/alias match or direct registry record before filling ISIN. |
...
| missing_isin_primary | fund_or_trust_identifier_gap | NYSE MKT | 19 | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | Exact fund/trust symbol and product name with checksum. |
