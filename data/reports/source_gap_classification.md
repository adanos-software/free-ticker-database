...
Generated at: `2026-08-12T07:49:51Z`
...
- Official reference-gap rows classified: `6457`
- Missing primary ISIN rows classified: `1134`
- Missing stock-sector rows classified: `1898`
- Missing ETF-category rows classified: `395`
...
| official_reference_symbol_collision_gap | 1213 |
| exchange_industry_source_gap | 922 |
...
|---|---|---|---:|---|---|
| official_reference_gap | official_reference_unmatched_source_gap | OTC | 3116 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
| missing_sector_stock | exchange_industry_source_gap | FSX | 860 | Official exchange industry feed or reviewed secondary company profile. | Exact exchange/symbol/name mapped to canonical stock sector. |
...
| official_reference_gap | official_reference_symbol_collision_gap | BMV | 164 | Official exchange directory plus listing-key review for the row's exchange/security. | Do not close the gap from a same-symbol match on another exchange; require exact exchange/symbol/name/identifier evidence. |
| official_reference_gap | official_reference_unmatched_source_gap | BMV | 163 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
| official_reference_gap | official_reference_symbol_collision_gap | OTC | 141 | Official exchange directory plus listing-key review for the row's exchange/security. | Do not close the gap from a same-symbol match on another exchange; require exact exchange/symbol/name/identifier evidence. |
...
| missing_isin_primary | official_identifier_not_exposed_source_gap | NASDAQ | 105 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
...
| missing_isin_primary | fund_or_trust_identifier_gap | NYSE ARCA | 88 | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | Exact fund/trust symbol and product name with checksum. |
