...
Generated at: `2026-08-01T08:56:21Z`
...
- Official reference-gap rows classified: `6680`
- Missing primary ISIN rows classified: `799`
- Missing stock-sector rows classified: `47`
- Missing ETF-category rows classified: `122`
...
| official_reference_gap | official_reference_unmatched_source_gap | TSX | 135 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
...
| official_reference_gap | official_reference_unmatched_source_gap | TSXV | 97 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
| missing_isin_primary | official_identifier_not_exposed_source_gap | NASDAQ | 96 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
