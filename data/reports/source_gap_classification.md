...
Generated at: `2026-07-15T08:58:51Z`
...
- Official reference-gap rows classified: `5623`
- Missing primary ISIN rows classified: `734`
- Missing stock-sector rows classified: `12`
- Missing ETF-category rows classified: `84`

## Top Classes

| Class | Rows |
|---|---:|
| official_reference_unmatched_source_gap | 4912 |
| official_reference_symbol_collision_gap | 711 |
| fund_or_trust_identifier_gap | 321 |
| official_identifier_not_exposed_source_gap | 234 |
...
| missing_isin_primary | official_identifier_not_exposed_source_gap | NASDAQ | 75 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
...
| missing_isin_primary | fund_or_trust_identifier_gap | NYSE ARCA | 66 | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | Exact fund/trust symbol and product name with checksum. |
