...
Generated at: `2026-09-10T11:19:55Z`
...
- Official reference-gap rows classified: `7247`
- Missing primary ISIN rows classified: `807`
- Missing stock-sector rows classified: `1518`
- Missing ETF-category rows classified: `54`

## Top Classes

| Class | Rows |
|---|---:|
| official_reference_unmatched_source_gap | 6176 |
| official_reference_symbol_collision_gap | 1071 |
| official_industry_taxonomy_unavailable_gap | 842 |
| otc_sector_source_gap | 554 |
| fund_or_trust_identifier_gap | 308 |
| official_identifier_not_exposed_source_gap | 303 |
| debt_or_securitized_identifier_gap | 87 |
| exchange_industry_source_gap | 63 |
| adr_cdr_or_depositary_identifier_gap | 44 |
| official_product_taxonomy_unavailable_gap | 41 |
...
| official_reference_gap | official_reference_unmatched_source_gap | B3 | 1207 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
