...
Generated at: `2026-09-08T09:34:21Z`
...
- Official reference-gap rows classified: `6273`
- Missing primary ISIN rows classified: `769`
...
| Class | Rows |
|---|---:|
| official_reference_unmatched_source_gap | 5203 |
| official_reference_symbol_collision_gap | 1070 |
| official_industry_taxonomy_unavailable_gap | 852 |
| otc_sector_source_gap | 554 |
| official_identifier_not_exposed_source_gap | 292 |
...
| official_reference_gap | official_reference_unmatched_source_gap | NASDAQ | 157 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
