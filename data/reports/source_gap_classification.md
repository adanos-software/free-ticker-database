...
- Official reference-gap rows classified: `5919`
...
| official_reference_gap | official_reference_unmatched_source_gap | NASDAQ | 111 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
