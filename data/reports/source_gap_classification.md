...
Generated at: `2026-09-08T13:16:17Z`
...
- Official reference-gap rows classified: `6359`
- Missing primary ISIN rows classified: `793`
- Missing stock-sector rows classified: `1516`
...
| Class | Rows |
|---|---:|
| official_reference_unmatched_source_gap | 5296 |
| official_reference_symbol_collision_gap | 1063 |
| official_industry_taxonomy_unavailable_gap | 840 |
| otc_sector_source_gap | 554 |
| fund_or_trust_identifier_gap | 298 |
| official_identifier_not_exposed_source_gap | 293 |
| debt_or_securitized_identifier_gap | 86 |
...
| official_product_taxonomy_unavailable_gap | 33 |
...
| official_reference_gap | official_reference_unmatched_source_gap | BSE_IN | 201 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
...
| official_reference_gap | official_reference_unmatched_source_gap | NASDAQ | 124 | Fresh official exchange directory, scoped alias review, or source-of-truth decision. | Require an active official reference match for the listing key, or a documented blocker/out-of-scope decision. |
...
| missing_isin_primary | fund_or_trust_identifier_gap | NYSE ARCA | 73 | Official fund/trust masterfile, prospectus, or reviewed identifier feed. | Exact fund/trust symbol and product name with checksum. |
