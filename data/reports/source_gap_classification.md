...
Generated at: `2026-06-17T10:47:07Z`
...
- Missing primary ISIN rows classified: `813`
- Missing stock-sector rows classified: `66`
...
| missing_sector_stock | otc_sector_source_gap | OTC | 41 | SEC SIC, issuer filings, OTCMarkets profile, or reviewed secondary company profile. | Canonical stock sector only after exchange/name gate; no ticker/name-only inference. |
...
| missing_isin_primary | official_identifier_not_exposed_source_gap | NASDAQ | 38 | Separate official CSD/security registry or exchange detail feed with ISIN. | Exact symbol/name and direct ISIN evidence; do not infer from issuer name or exchange membership. |
