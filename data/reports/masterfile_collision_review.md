...
Generated: 2026-06-02T19:18:19Z
...
- Rows: `11176`
- Same-ISIN exact-name scope review rows: `331`
- Same-ISIN name/scope reconciliation rows: `3839`
- Distinct official-ISIN listing-add review rows: `2196`
- Asset-type conflict blocked rows: `1620`
- Symbol-only non-symbol identity required rows: `3190`
...
| Queue | Rows |
| --- | ---: |
| blocked_asset_type_conflict | 1620 |
| blocked_symbol_only_missing_non_symbol_identity | 3190 |
| review_cross_listing_same_isin_exact_name | 331 |
| review_cross_listing_same_isin_name_or_scope_gap | 3839 |
| review_distinct_official_isin_new_listing | 2196 |

## Identity Resolution Clearance Readiness

| Readiness | Rows |
| --- | ---: |
| blocked_symbol_only_non_symbol_identity_required | 3190 |
| blocked_until_asset_type_conflict_resolved | 1620 |
| needs_official_listing_add_review | 2196 |
| needs_official_name_or_scope_reconciliation | 3839 |
| review_ready_same_isin_exact_name_scope_check | 331 |

## Top Clearance Batches

| Queue | Readiness | Rows | Review Strategy | Evidence Required | Source Gate |
| --- | --- | ---: | --- | --- | --- |
| review_cross_listing_same_isin_name_or_scope_gap | needs_official_name_or_scope_reconciliation | 3839 | batch_review_same_isin_name_or_scope_reconciliation | official_target_exchange_status_plus_issuer_or_name_scope_reconciliation | Do not resolve identity until official listing status and issuer/name or scope differences are reconciled. |
| blocked_symbol_only_missing_non_symbol_identity | blocked_symbol_only_non_symbol_identity_required | 3190 | batch_hold_symbol_reuse_until_non_symbol_identity_source | official_non_symbol_identifier_or_keep_absent | Keep absent; ticker equality alone is not identity evidence. |
| review_distinct_official_isin_new_listing | needs_official_listing_add_review | 2196 | batch_review_distinct_isin_new_listing_candidates | official_target_exchange_listing_key_isin_name_instrument_type_listing_status | Do not add the listing until official target-exchange evidence proves key, ISIN, name, type, and active status. |
| blocked_asset_type_conflict | blocked_until_asset_type_conflict_resolved | 1620 | batch_block_instrument_type_conflict_until_official_resolution | official_instrument_type_resolution_before_listing_identity_review | Block identity resolution until official instrument-type evidence resolves the conflict. |
| review_cross_listing_same_isin_exact_name | review_ready_same_isin_exact_name_scope_check | 331 | batch_review_same_isin_exact_name_cross_listing_scope | official_target_and_existing_exchange_directories_confirm_active_same_instrument | Do not add or merge until both official exchange directories confirm the same active instrument. |
...
| Euronext::XETRA | euronext_etfs | ETF | official_target_exchange_listing_status_mic_name_instrument_type | 71 | Official active-listing directories for both exchanges in Euronext::XETRA. | Do not add or merge until both official exchange directories confirm the same active instrument. |
...
| BSE_IN::NSE_IN | bse_india_scrips | Stock | official_target_exchange_listing_status_mic_name_instrument_type | 11 | Official active-listing directories for both exchanges in BSE_IN::NSE_IN. | Do not add or merge until both official exchange directories confirm the same active instrument. |
...
| --- | --- | ---: |
| blocked_asset_type_conflict | ETF | 646 |
| blocked_asset_type_conflict | Stock | 974 |
| blocked_symbol_only_missing_non_symbol_identity | ETF | 158 |
| blocked_symbol_only_missing_non_symbol_identity | Stock | 3032 |
| review_cross_listing_same_isin_exact_name | ETF | 301 |
| review_cross_listing_same_isin_exact_name | Stock | 30 |
| review_cross_listing_same_isin_name_or_scope_gap | ETF | 2636 |
| review_cross_listing_same_isin_name_or_scope_gap | Stock | 1203 |
| review_distinct_official_isin_new_listing | ETF | 251 |
| review_distinct_official_isin_new_listing | Stock | 1945 |
...
| blocked_asset_type_conflict | deutsche_boerse_xetra_all_tradable_equities | 113 |
| blocked_asset_type_conflict | dfm_listed_securities | 1 |
| blocked_asset_type_conflict | euronext_equities | 84 |
| blocked_asset_type_conflict | euronext_etfs | 178 |
| blocked_asset_type_conflict | hkex_securities_list | 83 |
...
| blocked_asset_type_conflict | lse_price_explorer | 236 |
| blocked_asset_type_conflict | muscat_securities_companies | 2 |
| blocked_asset_type_conflict | nasdaq_listed | 30 |
...
| blocked_symbol_only_missing_non_symbol_identity | nasdaq_listed | 50 |
| blocked_symbol_only_missing_non_symbol_identity | nasdaq_other_listed | 172 |
...
| blocked_symbol_only_missing_non_symbol_identity | twse_listed_companies | 9 |
| review_cross_listing_same_isin_exact_name | adx_market_watch | 1 |
| review_cross_listing_same_isin_exact_name | bse_india_scrips | 11 |
...
| review_cross_listing_same_isin_exact_name | euronext_etfs | 300 |
...
| review_cross_listing_same_isin_name_or_scope_gap | bse_india_scrips | 478 |
...
| review_cross_listing_same_isin_name_or_scope_gap | deutsche_boerse_xetra_all_tradable_equities | 593 |
...
| review_cross_listing_same_isin_name_or_scope_gap | euronext_etfs | 1593 |
| review_cross_listing_same_isin_name_or_scope_gap | hnx_listed_securities | 1 |
| review_cross_listing_same_isin_name_or_scope_gap | lse_price_explorer | 709 |
| review_cross_listing_same_isin_name_or_scope_gap | nse_india_securities_available | 134 |
...
| review_distinct_official_isin_new_listing | bse_india_scrips | 227 |
...
| review_distinct_official_isin_new_listing | deutsche_boerse_xetra_all_tradable_equities | 95 |
...
| review_distinct_official_isin_new_listing | euronext_etfs | 66 |
...
| review_distinct_official_isin_new_listing | lse_price_explorer | 237 |
| review_distinct_official_isin_new_listing | nse_india_securities_available | 155 |
...
| review_distinct_official_isin_new_listing | twse_listed_companies | 26 |
...
| blocked_asset_type_conflict | XETRA::OTC | 28 |
...
| blocked_asset_type_conflict | NASDAQ::LSE | 10 |
...
| blocked_symbol_only_missing_non_symbol_identity | NASDAQ::ASX | 10 |
...
| review_cross_listing_same_isin_name_or_scope_gap | Euronext::LSE | 660 |
| review_cross_listing_same_isin_name_or_scope_gap | BSE_IN::NSE_IN | 477 |
| review_cross_listing_same_isin_name_or_scope_gap | Euronext::XETRA | 384 |
...
| review_cross_listing_same_isin_name_or_scope_gap | NSE_IN::BSE_IN | 134 |
...
| review_cross_listing_same_isin_name_or_scope_gap | Euronext::AMS | 58 |
...
| review_cross_listing_same_isin_name_or_scope_gap | AMS::NYSE ARCA | 22 |
...
| review_cross_listing_same_isin_name_or_scope_gap | LSE::TSX | 15 |
| review_cross_listing_same_isin_name_or_scope_gap | XETRA::ASX | 15 |
...
| review_cross_listing_same_isin_name_or_scope_gap | LSE::Euronext | 9 |
...
| review_cross_listing_same_isin_name_or_scope_gap | LSE::NYSE MKT | 8 |
...
| review_distinct_official_isin_new_listing | UPCOM::NYSE | 84 |
...
| review_distinct_official_isin_new_listing | Euronext::NASDAQ | 42 |
...
| review_distinct_official_isin_new_listing | LSE::NYSE ARCA | 32 |
| review_distinct_official_isin_new_listing | UPCOM::WSE | 29 |
| review_distinct_official_isin_new_listing | XETRA::NYSE ARCA | 28 |
| review_distinct_official_isin_new_listing | NSE_IN::NYSE | 27 |
...
| review_distinct_official_isin_new_listing | BSE_IN::NASDAQ | 20 |
| review_distinct_official_isin_new_listing | BVB::NYSE | 20 |
| review_distinct_official_isin_new_listing | Euronext::ASX | 20 |
| review_distinct_official_isin_new_listing | NSE_IN::NASDAQ | 20 |
...
| review_distinct_official_isin_new_listing | NSE_IN::ASX | 18 |
| review_distinct_official_isin_new_listing | TADAWUL::TPEX | 17 |
| review_distinct_official_isin_new_listing | UPCOM::NASDAQ | 17 |
| review_distinct_official_isin_new_listing | UPCOM::TSX | 17 |
| review_distinct_official_isin_new_listing | PSE::NASDAQ | 16 |
| review_distinct_official_isin_new_listing | Euronext::NYSE ARCA | 15 |
...
| review_distinct_official_isin_new_listing | Euronext::BATS | 12 |
...
| blocked_asset_type_conflict | XETRA::NASDAQ | 42 | batch_block_instrument_type_conflict_until_official_resolution | official_instrument_type_resolution_before_listing_identity_review | Official instrument-type evidence resolving the asset-type conflict for XETRA::NASDAQ. | Block identity resolution until official instrument-type evidence resolves the conflict. |
...
| review_cross_listing_same_isin_exact_name | BSE_IN::NSE_IN | 11 | batch_review_same_isin_exact_name_cross_listing_scope | official_target_and_existing_exchange_directories_confirm_active_same_instrument | Official active-listing directories for both exchanges in BSE_IN::NSE_IN. | Do not add or merge until both official exchange directories confirm the same active instrument. |
...
| review_cross_listing_same_isin_name_or_scope_gap | NSE_IN::BSE_IN | 134 | batch_review_same_isin_name_or_scope_reconciliation | official_target_exchange_status_plus_issuer_or_name_scope_reconciliation | Official target-exchange status plus issuer/name or scope reconciliation for NSE_IN::BSE_IN. | Do not resolve identity until official listing status and issuer/name or scope differences are reconciled. |
...
| review_distinct_official_isin_new_listing | Euronext::NASDAQ | 42 | batch_review_distinct_isin_new_listing_candidates | official_target_exchange_listing_key_isin_name_instrument_type_listing_status | Official target-exchange listing record for Euronext::NASDAQ with listing key, ISIN, name, type, and status. | Do not add the listing until official target-exchange evidence proves key, ISIN, name, type, and active status. |
...
| Queue | Strategy | Rows |
| --- | --- | ---: |
| blocked_asset_type_conflict | batch_block_instrument_type_conflict_until_official_resolution | 1620 |
| blocked_symbol_only_missing_non_symbol_identity | batch_hold_symbol_reuse_until_non_symbol_identity_source | 3190 |
| review_cross_listing_same_isin_exact_name | batch_review_same_isin_exact_name_cross_listing_scope | 331 |
| review_cross_listing_same_isin_name_or_scope_gap | batch_review_same_isin_name_or_scope_reconciliation | 3839 |
| review_distinct_official_isin_new_listing | batch_review_distinct_isin_new_listing_candidates | 2196 |

## Identity Resolution Evidence Required

| Queue | Evidence Required | Rows |
| --- | --- | ---: |
| blocked_asset_type_conflict | official_instrument_type_resolution_before_listing_identity_review | 1620 |
| blocked_symbol_only_missing_non_symbol_identity | official_non_symbol_identifier_or_keep_absent | 3190 |
| review_cross_listing_same_isin_exact_name | official_target_and_existing_exchange_directories_confirm_active_same_instrument | 331 |
| review_cross_listing_same_isin_name_or_scope_gap | official_target_exchange_status_plus_issuer_or_name_scope_reconciliation | 3839 |
| review_distinct_official_isin_new_listing | official_target_exchange_listing_key_isin_name_instrument_type_listing_status | 2196 |

## Identity Resolution Identity Evidence

| Queue | Identity Evidence | Rows |
| --- | --- | ---: |
| blocked_asset_type_conflict | asset_type_conflict | 1620 |
| blocked_asset_type_conflict | exact_name_match | 4 |
| blocked_asset_type_conflict | official_isin | 1036 |
| blocked_asset_type_conflict | same_isin_existing_listing | 443 |
| blocked_symbol_only_missing_non_symbol_identity | asset_type_consistent | 3190 |
| blocked_symbol_only_missing_non_symbol_identity | exact_name_match | 166 |
| review_cross_listing_same_isin_exact_name | asset_type_consistent | 331 |
| review_cross_listing_same_isin_exact_name | exact_name_match | 331 |
| review_cross_listing_same_isin_exact_name | official_isin | 331 |
| review_cross_listing_same_isin_exact_name | same_isin_existing_listing | 331 |
| review_cross_listing_same_isin_name_or_scope_gap | asset_type_consistent | 3839 |
| review_cross_listing_same_isin_name_or_scope_gap | official_isin | 3839 |
| review_cross_listing_same_isin_name_or_scope_gap | same_isin_existing_listing | 3839 |
| review_distinct_official_isin_new_listing | asset_type_consistent | 2196 |
| review_distinct_official_isin_new_listing | exact_name_match | 3 |
| review_distinct_official_isin_new_listing | official_isin | 2196 |

## Identity Resolution Risk Flags

| Queue | Risk Flag | Rows |
| --- | --- | ---: |
| blocked_asset_type_conflict | asset_type_mismatch | 1620 |
| blocked_asset_type_conflict | exact_name_match | 4 |
| blocked_asset_type_conflict | existing_isin_conflict | 871 |
| blocked_asset_type_conflict | missing_official_isin | 584 |
| blocked_asset_type_conflict | no_exact_name_match | 1616 |
| blocked_asset_type_conflict | same_isin_existing_listing | 443 |
| blocked_asset_type_conflict | ticker_reused_on_other_exchange | 1620 |
| blocked_symbol_only_missing_non_symbol_identity | exact_name_match | 166 |
| blocked_symbol_only_missing_non_symbol_identity | missing_official_isin | 3190 |
| blocked_symbol_only_missing_non_symbol_identity | multiple_existing_symbol_rows | 1 |
| blocked_symbol_only_missing_non_symbol_identity | no_exact_name_match | 3024 |
| blocked_symbol_only_missing_non_symbol_identity | ticker_reused_on_other_exchange | 3190 |
| review_cross_listing_same_isin_exact_name | exact_name_match | 331 |
| review_cross_listing_same_isin_exact_name | existing_isin_conflict | 2 |
| review_cross_listing_same_isin_exact_name | same_isin_existing_listing | 331 |
| review_cross_listing_same_isin_exact_name | ticker_reused_on_other_exchange | 331 |
| review_cross_listing_same_isin_name_or_scope_gap | existing_isin_conflict | 759 |
| review_cross_listing_same_isin_name_or_scope_gap | multiple_existing_symbol_rows | 1 |
| review_cross_listing_same_isin_name_or_scope_gap | no_exact_name_match | 3839 |
| review_cross_listing_same_isin_name_or_scope_gap | same_isin_existing_listing | 3839 |
| review_cross_listing_same_isin_name_or_scope_gap | ticker_reused_on_other_exchange | 3839 |
| review_distinct_official_isin_new_listing | exact_name_match | 3 |
| review_distinct_official_isin_new_listing | existing_isin_conflict | 2171 |
| review_distinct_official_isin_new_listing | no_exact_name_match | 2193 |
| review_distinct_official_isin_new_listing | ticker_reused_on_other_exchange | 2196 |

## Decisions

| Decision | Rows |
| --- | ---: |
| new_listing_candidate_requires_official_listing_add_review | 2789 |
| same_isin_cross_listing_candidate_requires_exchange_scope_review | 4613 |
| symbol_collision_requires_non_symbol_identity_source | 3774 |

## Review Buckets

| Priority | Bucket | Rows |
| --- | --- | ---: |
| P2 | distinct_official_isin_new_listing_candidate | 2196 |
| P3 | hold_symbol_only_collision_needs_non_symbol_identity | 3190 |
| P2 | resolve_asset_type_conflict_before_identity_review | 1620 |
| P2 | same_isin_cross_listing_needs_name_or_scope_review | 3839 |
| P1 | same_isin_exact_name_cross_listing_candidate | 331 |

## Clearance Evidence

| Evidence Gate | Rows |
| --- | ---: |
| official_instrument_type_resolution_before_listing_identity_review | 1620 |
| official_non_symbol_identifier_or_keep_absent | 3190 |
| official_target_exchange_listing_key_isin_name_instrument_type_listing_status | 2196 |
| official_target_exchange_listing_status_mic_name_instrument_type | 331 |
| official_target_exchange_listing_status_plus_name_or_scope_reconciliation | 3839 |

## Risk Flags

| Flag | Rows |
| --- | ---: |
| asset_type_mismatch | 1620 |
| exact_name_match | 504 |
| existing_isin_conflict | 3803 |
| missing_official_isin | 3774 |
| multiple_existing_symbol_rows | 2 |
| no_exact_name_match | 10672 |
| same_isin_existing_listing | 4613 |
| ticker_reused_on_other_exchange | 11176 |
