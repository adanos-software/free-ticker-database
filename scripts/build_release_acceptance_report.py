...
RELEASE_SOURCE_REPORTS = {
    ...
    "twelvedata_batch_b_second_source_queue": "data/reports/twelvedata_batch_b_second_source_queue_summary.json",
    "twelvedata_batch_c_second_source_queue": "data/reports/twelvedata_batch_c_second_source_queue_summary.json",
