...
FILES = [
    ...
    DatasetFile(
        ...
        "Observed listing lifecycle events from the listing history workflow.",
        {
            ...
            "field_name": "Critical field that changed, when the event is a field update.",
            "old_value": "Previous value when applicable.",
            "new_value": "New value when applicable.",
            "before_row_sha256": "Fingerprint of the listing row before the event.",
            "effective_at": "Effective timestamp when known.",
            "observed_at": "UTC timestamp or date when the event was observed.",
            "source_key": "Provenance source key for the event.",
            "source_url": "Provenance source URL when available.",
            "source_report": "Report or override file that supplied the event evidence.",
            "observation_id": "Stable observation identifier for the evidence row.",
            "evidence_status": "Evidence class such as official, reviewed, verified, or observed_unverified.",
        },
    ),
    DatasetFile(
