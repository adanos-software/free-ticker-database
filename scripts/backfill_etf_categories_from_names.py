...
ETF_CATEGORY_RULES: tuple[CategoryRule, ...] = (
    ...
    rule(
        ...
        r"\bbuywrite\b",
        r"\bbuy[- ]write\b",
        r"\btarget drawdown\b",
        r"\brisk[- ]managed\b",
        r"\bmanaged risk\b",
        r"\bhedge replication\b",
        r"\bbuy and hedge\b",
        r"\bevent[- ]driven\b",
        r"\bmerger\b",
        ...
        r"\bincome blast\b",
        r"\byield prm stgy\b",
        r"\btarget \d+ (?:income|distribution)\b",
        r"\bsystematic style premia\b",
        r"\bmarket navigation\b",
        r"\bopportunistic trader\b",
        r"\bprivate[- ]public crossover\b",
        r"\bpe/vc\b",
        r"\bpe etf\b",
        r"\bultra option\b",
        r"\bdefensive equity\b",
        r"\barbitrage\b",
        r"\bdeflation\b",
        r"\bstable income\b",
        r"\bincome bucket\b",
    ...
    rule(
        ...
        r"\bglobal carbon\b",
        r"\bglobal equality\b",
        r"\bconscious companies\b",
        r"\btopgun\b",
        r"\bfoundational\b",
        r"\bbeta builders\b",
        r"\bbetabuilders\b",
        ...
        r"\bdigital entertainment\b",
        r"\bsmart factories\b",
        r"\bcardiovascular\b",
        r"\bweight loss\b",
        r"\bcleaner planet\b",
        r"\bnuclear\b",
        ...
        r"\bsmart mobility\b",
        r"\bdata and digital revolution\b",
        r"\btransformers\b",
        r"\bsea to sky cargo\b",
        r"\bspac and new issue\b",
        r"\bshareholder yield\b",
        r"\br&d champions\b",
        r"\bdeglobalization\b",
        r"\bus market etf\b",
        r"\bsector etf\b",
        r"\badrhedged\b",
        r"\btech leaders?\b",
