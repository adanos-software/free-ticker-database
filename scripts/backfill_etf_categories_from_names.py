...
ETF_CATEGORY_RULES: tuple[CategoryRule, ...] = (
    ...
    rule("Value", "value", r"\bvalue\b", r"\bdividend\b", r"\bsuperdividend\b", "\ubc30\ub2f9", "\u7ea2\u5229", "\u4f4e\u6ce2"),
    rule(
        "Factors",
        "factors",
        r"\bfactor\b",
    ...
    rule("Information Technology", "information_technology", r"\btechnology\b", r"\btechnical lead\b", r"\btchnlgy\b", r"\bdigital payment\b", r"\bwafer\b", r"\bsemiconductor\b", r"\bsemicon\b", r"\bsoftware\b", r"\bai\b", r"\bquantum computing\b", r"\bcloud(?: computing)?\b", r"\bcyber(?:security)?\b", r"\bcomputer\b", r"\b5g\b", r"\bfintech\b", r"\bcleantech\b", r"\bbig data\b", r"\bstreaming\b", r"\bgaming\b", r"\bvideo games?\b", r"\besports?\b", r"\bcritical technologies\b", r"\bblockchain\b", r"\bweb3\b", r"\brobot", r"\binformation security\b", r"\biot\b", "\ubc18\ub3c4\uccb4", "\ud14c\ud06c", "\uc591\uc790\ucef4\ud4e8\ud305", "\uc815\ubcf4\ubcf4\uc548", "\uc2e0\ucc3d", "\u79d1\u6280", "\u5927\u6570\u636e", "\u901a\u4fe1", "\u7269\u8054\u7f51", "\u4eba\u5de5\u667a\u80fd", "\u6570\u5b57\u7ecf\u6d4e", "\u534a\u5bfc\u4f53", "\u96c6\u6210\u7535\u8def", "\u82af\u7247", "\u4e91\u8ba1\u7b97", "\u4fe1\u521b", "\u7f51\u7edc\u5b89\u5168", "\u901a\u4fe1"),
