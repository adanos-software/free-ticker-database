...
ETF_CATEGORY_RULES: tuple[CategoryRule, ...] = (
    ...
    rule("Corporate Bonds", "corporate_bonds", r"\bcorporate bonds?\b", r"\bcorp(?:orate)?\b", "\ud68c\uc0ac\ucc44"),
    ...
    rule("Currencies", "currencies", r"\bcurrency(?: basket| etf| fund|shares)\b", r"\bforex\b", r"\bfx\b", r"\bdollar index\b", r"\busd futures\b", r"\bjpykrw futures\b"),
    rule(
        "Real Estate",
    ...
    rule("Value", "value", r"\bvalue\b", r"\bdividend\b", "\ubc30\ub2f9", "\u7ea2\u5229", "\u4f4e\u6ce2"),
    rule(
        "Factors",
        "factors",
        r"\bfactor\b",
    ...
    rule("Health Care", "health_care", r"\bhealth ?care\b", r"\bmedical\b", r"\bmedical devices?\b", r"\bbiotech\b", r"\bpharma(?:ceuticals?)?\b", r"\bbio\b", r"\bvaccine\b", "\uc758\ub8cc", "\ubc14\uc774\uc624", "\u533b\u7597", "\u521b\u65b0\u836f", "\u75ab\u82d7", "\u4e2d\u836f", "\u533b\u836f", "\u751f\u7269\u533b\u836f", "\u751f\u7269\u79d1\u6280"),
    rule("Information Technology", "information_technology", r"\btechnology\b", r"\btechnical lead\b", r"\bsemiconductor\b", r"\bsemicon\b", r"\bsoftware\b", r"\bai\b", r"\bquantum computing\b", r"\bcloud(?: computing)?\b", r"\bcyber(?:security)?\b", r"\bcomputer\b", r"\b5g\b", r"\bfintech\b", r"\bcleantech\b", r"\bbig data\b", r"\bstreaming\b", r"\bgaming\b", r"\bvideo games?\b", r"\besports?\b", r"\bcritical technologies\b", r"\bblockchain\b", r"\bweb3\b", r"\brobot", r"\binformation security\b", r"\biot\b", "\ubc18\ub3c4\uccb4", "\ud14c\ud06c", "\uc591\uc790\ucef4\ud4e8\ud305", "\uc815\ubcf4\ubcf4\uc548", "\uc2e0\ucc3d", "\u79d1\u6280", "\u5927\u6570\u636e", "\u901a\u4fe1", "\u7269\u8054\u7f51", "\u4eba\u5de5\u667a\u80fd", "\u6570\u5b57\u7ecf\u6d4e", "\u534a\u5bfc\u4f53", "\u96c6\u6210\u7535\u8def", "\u82af\u7247", "\u4e91\u8ba1\u7b97", "\u4fe1\u521b", "\u7f51\u7edc\u5b89\u5168", "\u901a\u4fe1"),
    ...
    rule("Real Estate", "real_estate", r"\breit\b", r"\breal estate\b", r"\bimob(?:ili[áa]rio)?\b", r"\blog[ií]stic", r"\bshoppings?\b", r"\bresidenciais\b", r"\burbana\b", "\u5730\u4ea7", "\u623f\u5730\u4ea7"),
    ...
    rule("Consumer Discretionary", "consumer_discretionary", r"\bconsumer discretionary\b", r"\bconsumer trends?\b", r"\bhome construction\b", r"\bcosmetics\b", r"\btour(?:ism)?\b", r"\bleisure\b", r"\bautos?\b", "\u5316\u5986\u54c1", "\u5bb6\u7535", "\u6559\u80b2", "\u65c5\u6e38", "\u6c7d\u8f66", "\u6d88\u8d39", "\uc18c\ube44"),
    rule("Communication Services", "communication_services", r"\bcommunication services\b", r"\bmedia\b", r"\btelecom\b", r"\binternet\b", "\u4e2d\u6982\u4e92\u8054", "\u4e2d\u6982\u4e92\u8054\u7f51", "\u4e92\u8054\u7f51", "\u4f20\u5a92", "\u6e38\u620f", "\ud1b5\uc2e0"),
    rule("Industrials", "industrials", r"\bindustrials?\b", r"\bmanufactur(?:ing|ers?)\b", r"\binfrastructure\b", r"\bconstruction\b", r"\bheavy industry\b", r"\bdefense\b", r"\bmilitary\b", r"\bautonomous\b", r"\belectric vehicles?\b", r"\bhumanoid\b", r"\bmachinar(?:y|ies)\b", r"\bequipment\b", "\u4e00\u5e26\u4e00\u8def", "\u519b\u5de5", "\u519b\u5de5\u9f99\u5934", "\u4ea4\u8fd0", "\u4ea4\u901a\u8fd0\u8f93", "\u5de5\u4e1a\u6bcd\u673a", "\u673a\u5e8a", "\u673a\u5668\u4eba", "\u539f\u5b50\u529b", "\u56fd\u9632", "\u539f\u5b50\u529b", "\u6c7d\u8f66", "\u9ad8\u7aef\u88c5\u5907", "\ub85c\ubd07", "\ud734\uba38\ub178\uc774\ub4dc", "\uc6d0\uc790\ub825", "\uc81c\uc870", "\u57fa\u5efa", "\u5236\u9020"),
    rule(
        "Equities",
        "equities",
        r"\bequit(?:y|ies)\b",
