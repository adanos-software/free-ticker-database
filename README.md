...
| Aliases | 125,507 | Rows in `data/aliases.csv`; structured alias/name/identifier lookup rows. |
| ISIN coverage | 62,551 (98.0%) | Primary ticker rows with a non-empty `isin`. |
| FIGI coverage | 65,402 | Listing-keyed rows in `data/identifiers_extended.csv` with OpenFIGI coverage. |
