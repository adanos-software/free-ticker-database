...
| Aliases | 125,208 | Rows in `data/aliases.csv`; structured alias/name/identifier lookup rows. |
...
| Entry quality source-gap rows | 20,954 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
