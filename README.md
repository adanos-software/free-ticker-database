...
| Aliases | 125,514 | Rows in `data/aliases.csv`; structured alias/name/identifier lookup rows. |
...
| Entry quality source-gap rows | 11,570 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
