...
| Sector/category coverage | 53,416 (86.4%) | Primary ticker rows with either `stock_sector` or `etf_category`. |
| Stock sector coverage | 38,318 | Primary ticker rows with a non-empty `stock_sector`. |
