...
| Full listing rows | 92,060 | Rows in `data/listings.csv`; venue-level rows keyed by `listing_key`, including cross/secondary listings. |
...
| Entry quality source-gap rows | 11,646 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
