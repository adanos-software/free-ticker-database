...
| Sector/category coverage | 55,130 (89.1%) | Primary ticker rows with either `stock_sector` or `etf_category`. |
| Stock sector coverage | 39,998 | Primary ticker rows with a non-empty `stock_sector`. |
