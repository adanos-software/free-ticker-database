...
| Primary tickers | 63,237 | Rows in `data/tickers.csv`; one primary row per security. |
...
| Entry quality source-gap rows | 6,888 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
