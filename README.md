...
| Extended listing-scope rows | 16,923 | Rows in `data/instrument_scopes.csv` where `instrument_scope=extended`. |
...
| Entry quality source-gap rows | 6,811 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
