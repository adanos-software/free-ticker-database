...
| FIGI coverage | 65,636 | Listing-keyed rows in `data/identifiers_extended.csv` with OpenFIGI coverage. |
...
| Entry quality source-gap rows | 7,248 | Listing-keyed rows that are structurally valid but retain explicit source or metadata gaps. |
