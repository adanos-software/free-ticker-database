...
| Sector/category coverage | 53,753 (86.9%) | Primary ticker rows with either `stock_sector` or `etf_category`. |
| Stock sector coverage | 38,621 | Primary ticker rows with a non-empty `stock_sector`. |
