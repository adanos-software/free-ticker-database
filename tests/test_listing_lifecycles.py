...
def test_official_delisting_and_reappearance_create_two_lifecycles() -> None:
    rows = build_listing_lifecycles(
        ...
        [
            ...
            {"listing_key": "X::A", "ticker": "A", "exchange": "X", "status": "delisted", "effective_at": "2026-01-01T00:00:00Z", "evidence_status": "official"},
...
def test_historical_only_requires_trusted_delisting() -> None:
    rows = build_listing_lifecycles(
        [],
        [{"listing_key": "X::OLD", "ticker": "OLD", "exchange": "X", "status": "delisted", "effective_at": "2026-01-01T00:00:00Z", "evidence_status": "official"}],
        observed_at="2026-08-17T00:00:00Z",
    )
...
def test_repeated_delisting_evidence_does_not_create_fake_reuse() -> None:
    rows = build_listing_lifecycles(
        ...
        [
            {"listing_key": "X::OLD", "ticker": "OLD", "exchange": "X", "status": "delisted", "effective_at": "2026-01-01T00:00:00Z", "evidence_status": "official"},
            {"listing_key": "X::OLD", "ticker": "OLD", "exchange": "X", "status": "delisted", "effective_at": "2026-02-01T00:00:00Z", "evidence_status": "official"},
        ],
        observed_at="2026-08-17T00:00:00Z",
    )
    assert len(rows) == 1
...
def test_two_delistings_require_intervening_active_lifecycle() -> None:
    rows = build_listing_lifecycles(
        ...
        [
            ...
            {"listing_key": "X::A", "ticker": "A", "exchange": "X", "status": "delisted", "effective_at": "2025-06-01T00:00:00Z", "evidence_status": "official"},
            {"listing_key": "X::A", "ticker": "A", "exchange": "X", "status": "active", "first_observed_at": "2026-01-01T00:00:00Z"},
            {"listing_key": "X::A", "ticker": "A", "exchange": "X", "status": "delisted", "effective_at": "2026-06-01T00:00:00Z", "evidence_status": "official"},
        ],
        observed_at="2026-08-17T00:00:00Z",
    )
